...
const foodDatabase = [
    ...
    { name: "Chicken Thigh", calories: 209, protein: 26, carbs: 0, fats: 11, fiber: 0, per: 100 },
    { name: "Ground Beef", calories: 250, protein: 26, carbs: 0, fats: 17, fiber: 0, per: 100 },
    { name: "Tuna", calories: 132, protein: 28, carbs: 0, fats: 1.3, fiber: 0, per: 100 },
    { name: "Salmon", calories: 208, protein: 20, carbs: 0, fats: 13, fiber: 0, per: 100 },
    { name: "Shrimp", calories: 99, protein: 24, carbs: 0.2, fats: 0.3, fiber: 0, per: 100 },
    { name: "Eggs", calories: 155, protein: 13, carbs: 1.1, fats: 11, fiber: 0, per: 100 },
    { name: "Greek Yogurt", calories: 59, protein: 10, carbs: 3.6, fats: 0.4, fiber: 0, per: 100 },
    { name: "Milk", calories: 61, protein: 3.2, carbs: 4.8, fats: 3.3, fiber: 0, per: 100 },
    { name: "Cheese", calories: 402, protein: 25, carbs: 1.3, fats: 33, fiber: 0, per: 100 },
    { name: "Cottage Cheese", calories: 98, protein: 11, carbs: 3.4, fats: 4.3, fiber: 0, per: 100 },
    { name: "Tofu", calories: 76, protein: 8, carbs: 1.9, fats: 4.8, fiber: 0.3, per: 100 },
    { name: "White Rice", calories: 130, protein: 2.7, carbs: 28, fats: 0.3, fiber: 0.4, per: 100 },
    { name: "Brown Rice", calories: 112, protein: 2.6, carbs: 24, fats: 0.9, fiber: 1.8, per: 100 },
    { name: "Quinoa", calories: 120, protein: 4.4, carbs: 21, fats: 1.9, fiber: 2.8, per: 100 },
    { name: "Oatmeal", calories: 389, protein: 17, carbs: 66, fats: 7, fiber: 11, per: 100 },
    { name: "Whole Wheat Bread", calories: 247, protein: 13, carbs: 41, fats: 3.4, fiber: 7, per: 100 },
    { name: "Pasta", calories: 131, protein: 5, carbs: 25, fats: 1.1, fiber: 1.8, per: 100 },
    { name: "Potato", calories: 77, protein: 2, carbs: 17, fats: 0.1, fiber: 2.1, per: 100 },
    ...
    { name: "Apple", calories: 52, protein: 0.3, carbs: 14, fats: 0.2, fiber: 2.4, per: 100 },
    { name: "Orange", calories: 47, protein: 0.9, carbs: 12, fats: 0.1, fiber: 2.4, per: 100 },
    { name: "Strawberries", calories: 32, protein: 0.7, carbs: 7.7, fats: 0.3, fiber: 2, per: 100 },
    { name: "Blueberries", calories: 57, protein: 0.7, carbs: 14, fats: 0.3, fiber: 2.4, per: 100 },
    { name: "Avocado", calories: 160, protein: 2, carbs: 9, fats: 15, fiber: 7, per: 100 },
    { name: "Broccoli", calories: 34, protein: 2.8, carbs: 7, fats: 0.4, fiber: 2.6, per: 100 },
    { name: "Spinach", calories: 23, protein: 2.9, carbs: 3.6, fats: 0.4, fiber: 2.2, per: 100 },
    { name: "Carrots", calories: 41, protein: 0.9, carbs: 10, fats: 0.2, fiber: 2.8, per: 100 },
    { name: "Tomato", calories: 18, protein: 0.9, carbs: 3.9, fats: 0.2, fiber: 1.2, per: 100 },
    { name: "Cucumber", calories: 15, protein: 0.7, carbs: 3.6, fats: 0.1, fiber: 0.5, per: 100 },
    { name: "Almonds", calories: 579, protein: 21, carbs: 22, fats: 50, fiber: 12, per: 100 },
    { name: "Peanuts", calories: 567, protein: 26, carbs: 16, fats: 49, fiber: 8.5, per: 100 },
    { name: "Peanut Butter", calories: 588, protein: 25, carbs: 20, fats: 50, fiber: 6, per: 100 },
    { name: "Walnuts", calories: 654, protein: 15, carbs: 14, fats: 65, fiber: 7, per: 100 },
    { name: "Olive Oil", calories: 884, protein: 0, carbs: 0, fats: 100, fiber: 0, per: 100 },
    { name: "Butter", calories: 717, protein: 0.9, carbs: 0.1, fats: 81, fiber: 0, per: 100 },
    { name: "Honey", calories: 304, protein: 0.3, carbs: 82, fats: 0, fiber: 0.2, per: 100 },
    { name: "Dark Chocolate", calories: 546, protein: 5, carbs: 61, fats: 31, fiber: 7, per: 100 },
    { name: "Protein Powder", calories: 400, protein: 80, carbs: 10, fats: 5, fiber: 2, per: 100 }
];
...
function updateFoodLog() {
    ...
    list.innerHTML = foodLog.map((food, index) => `
        <div class="food-item">
            ...
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <button onclick="removeFood(${index})" style="background: #ff4444; color: white; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-size: 12px;">Remove</button>
            </div>
        </div>
    `).join('');
}
